...
class BookTestCase(TestCase):
    ...
    def test_books_list(self):
        ...
        book2 = Book.objects.create(title="Book2", description="Description2", isbn="523532543")
        book3 = Book.objects.create(title="Book3", description="Description3", isbn="1254235")
    ...
    def test_search_books(self):
        ...
        book2 = Book.objects.create(title="Guide", description="Description2", isbn="523532543")
        book3 = Book.objects.create(title="Shoe Dog", description="Description3", isbn="1254235")
...
class BookReviewTestCase(TestCase):
    def test_add_review(self):
        book = Book.objects.create(title="Book1", description="Description1", isbn="152345")
